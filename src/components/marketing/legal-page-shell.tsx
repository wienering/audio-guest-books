  ...
  return (
    <div className="bg-marketing-bg">
      ...
      <article className="mx-auto max-w-3xl space-y-8 px-4 pb-24 sm:px-6">
        ...
        <div className="space-y-10 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:tracking-tight [&_h2]:text-marketing-ink [&_h3]:font-serif [&_h3]:text-lg [&_h3]:tracking-tight [&_h3]:text-marketing-ink [&_p]:text-marketing-ink/85 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-1.5 [&_ul]:text-marketing-ink/85 [&_a]:text-marketing-accent [&_a]:hover:underline [&_section]:space-y-3">
          {children}
        </div>
      </article>
    </div>
