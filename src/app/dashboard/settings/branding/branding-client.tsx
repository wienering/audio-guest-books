        ...
        <div className="min-w-0 flex-1 lg:w-[40%] lg:flex-none">
          <div className="space-y-3">
            {SECTIONS.map((section) => (
              <details key={section.id} className="group rounded-lg border bg-card" open>
                <summary className="flex cursor-pointer list-none items-center justify-between px-4 py-3 text-sm font-medium touch-manipulation [&::-webkit-details-marker]:hidden">
